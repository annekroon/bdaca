...
\end{lstlisting}
\onslide<2->{
	\footnotesize{NB:  This will return a random sample of 10 items in the dictionary}}
\onslide<3->{\\
	\footnotesize{NB: Obviously, you can select samples in any size you want: \texttt{dict(random.sample(data.items(), 357))} allows you to get 357 items}}
\end{frame}
